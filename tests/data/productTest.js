...
describe("Test suite: Appliance", () => {
  ...
  it(" has the corect properties", () => {
    expect(appliace.id).toEqual("54e0eccd-8f36-462b-b68a-8182611d9add");
    expect(appliace.image).toEqual("images/products/black-2-slot-toaster.jpg");

    expect(appliace.instructionManualLink).toEqual(
      "images/appliance-instructions.png",
    );
    expect(appliace.warrantyLink).toEqual("images/appliance-warranty.png");
  });

  it("gets the stars url: ", () => {
    expect(appliace.getStartsUrl()).toEqual("images/ratings/rating-50.png");
  });

  it("get the price", () => {
    expect(appliace.getPrice()).toEqual("$18.99");
  });
